package com.applepulse.activeaura.ui
...
import com.applepulse.activeaura.databinding.ActivityHomeBinding
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AppBarConfiguration(setOf(R.id.home, R.id.appointment, R.id.settings))
